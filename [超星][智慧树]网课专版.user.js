...
function beforeFind() {
    ...
    setting.div = $(
        ...
        "<button><a href='http://juan.77zane.xyz/' target='_blank' style='text-decoration: none;color:black;'>考试版本</a></button>" +
        "<button style='margin-top: 5px; margin-right: 10px;'><a href='http://juan.77zane.xyz/' target='_blank' style='text-decoration: none;color:black;'>免费内测Token</a></button>" +
        "<button><a href='http://juan.77zane.xyz/' target='_blank' style='text-decoration: none;color:black;'>捐助我</a></button>" +
...
function findAnswer() {
    ...
    if (setting.num >= $('.TiMu').length) {
        var arr = setting.lose ? ['共有 <font color="red">' + setting.lose + '</font> 道题目待完善（已深色标注）', saveThis] : ['答题已完成&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://s3.ax1x.com/2020/11/16/Dk0IqP.png" target="_blank">公众号查题[涵盖多平台题库]</a>', submitThis];
