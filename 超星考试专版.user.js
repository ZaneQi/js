...
// @namespace       6677
// @version         1.0.0
// @description     超星网课助手集成多项功能，下载链接内附 | 解除各类功能限制，开放自定义参数
// @author          qackqi&Stars
...
setting.div = $(
    '<div style="border: 2px dashed rgb(149, 252, 251); width: 330px; position: fixed; top: 0; right: 0; z-index: 99999; background-color: rgba(184, 247, 255, 0.3); overflow-x: auto;">' +
        ...
        "<button style='margin-top: 5px; margin-right: 10px;'><a href='https://qm.qq.com/cgi-bin/qm/qr?k=JLlmfdNz1dTalq_Z3cMUWDPn9EuC45yU&jump_from=webapi' target='_blank' style='text-decoration: none;color:black;'>线报福利群</a></button>" +
        "<button style='margin-top: 5px; margin-right: 10px;'><a href='http://juan.77zane.xyz/' target='_blank' style='text-decoration: none;color:black;'>捐助我</a></button>" +
...
function findTiMu() {
    GM_xmlhttpRequest({
        method: 'POST',
        url: 'https://qackqi.cn/OnlineCourseBot/topic',
        data: 'q=' + encodeURIComponent(setting.TiMu[0]) + "&token=" + setting.token,
        headers: {
